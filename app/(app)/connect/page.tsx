 ...
 *
 * Číslování kroků tu zůstává — na rozdíl od zbytku appky jde o skutečný
 * postup nastavení, ne o dekoraci.
 */
export default function ConnectionPage() {
  ...
  return (
    <>
      <Topbar title="Připojení" />
      <PageShell width="narrow">
        <PageHeader
          eyebrow="Integrace"
          title="Ovládej faktury z ChatGPT"
        ...
        <section className="mb-14 sm:mb-20">
          <StepLabel number="03" title="Osobní tokeny" />
        ...
        <section>
          <StepLabel number="04" title="Co zkusit" />
